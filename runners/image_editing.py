...
from functions.data_loader import load_painting_data
...
class Diffusion(object):
    ...
    def image_editing_sample(self):
        ...
        with torch.no_grad():
            ...
            img = load_painting_data()[0][0]
            tvu.save_image(img, os.path.join(
                self.args.image_folder, f'raw.png'))
            tvu.save_image(mask, os.path.join(
                self.args.image_folder, f'mask.png'))
